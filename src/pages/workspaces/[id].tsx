...
export default function WorkspaceDetailPage() {
  ...
  const { data: item, isLoading } = useWorkspace(id!)
  ...
  if (!item)     return <div className="p-4 text-red-600">Workspace not found.</div>

  return (
    <div className="p-6 max-w-2xl">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Workspace Detail</h1>
      ...
      <dl className="divide-y divide-gray-200">
                ...
                <div className="py-3 grid grid-cols-3 gap-4">
                  ...
                  <dd className="text-sm text-gray-900 col-span-2">{String(item.icon ?? '—')}</dd>
                </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Workspace_Agency?.id ?? 'None'}
              </p>
            </div>
            ...
            <div className="mt-6">
              <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2">
                FK Workspace CreatedBy
              </h2>
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Workspace_CreatedBy?.id ?? 'None'}
              </p>
            </div>
