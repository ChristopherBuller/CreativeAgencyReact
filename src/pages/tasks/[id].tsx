...
export default function TaskDetailPage() {
  ...
  const { data: item, isLoading } = useTask(id!)
  ...
  if (!item)     return <div className="p-4 text-red-600">Task not found.</div>
    ...
    <div className="p-6 max-w-2xl">
      ...
      <dl className="divide-y divide-gray-200">
                ...
                <div className="py-3 grid grid-cols-3 gap-4">
                  ...
                  <dd className="text-sm text-gray-900 col-span-2">{String(item.estimatedHours ?? '—')}</dd>
                </div>
                ...
                <div className="py-3 grid grid-cols-3 gap-4">
                  ...
                  <dd className="text-sm text-gray-900 col-span-2">{String(item.completedAt ?? '—')}</dd>
                </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Task_Project?.id ?? 'None'}
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Task_Phase?.id ?? 'None'}
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Task_ParentTask?.id ?? 'None'}
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Task_Brief?.id ?? 'None'}
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Task_AssignedTo?.id ?? 'None'}
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-700">
                {(item as any)?.FK_Task_CreatedBy?.id ?? 'None'}
              </p>
            </div>
